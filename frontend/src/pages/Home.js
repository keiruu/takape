    ...
    return (
        <div className="md:bg-white">
            <Navbar/>
                ...
                <div className="flex bg-bgcolor rounded-b-0 md:rounded-b-1/2 justify-center items-center pt-6 lg:m-0 p-4 lg:my-0 py-10">
                    <Fade left cascade>
                        <div className="grid gap-y-6">
                            <h1 className="font-bold text-4xl lg:text-5xl text-accent md:pt-0 pt-10">Looking for a<br/>place to chill?</h1>
