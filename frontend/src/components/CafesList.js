...
export default function CafesList(props) {
    ...
    return (
        <div>
            <div className="flex flex-col gap-y-16 items-center bg-white">
                <div className="flex justify-center rounded-b-1/2 bg-bgcolor pb-20 w-full">
                    <div className="text-center pt-10">
                        ...
                        <h1 className="font-bold text-5xl text-accent">Find a list of cafes near you</h1>
                        ...
                        <div className="flex mt-4">
                                ...
                                <Tippy content={cafe.disabled ? "Please select a province first" : "Please select a city"} animation="scale" placement="bottom" disabled={tippy}>
                                    <div>
                                        <button disabled={cafe.buttonDisable} onClick={browseHandler} className="bg-bggradient border-2 border-transparent transition-all hover:border-white text-white text-md lg:text-lg py-1.5 px-17 lg:px-10 rounded-lg mb-32 md:mb-0 m-2" >
                                            Browse Now
                                        </button>
                                    </div>
                                </Tippy> 
                ...
                <div ref={scrollRef} className="bg-white w-full">
                    {show ? 
                        <div className=" flex-col mt-16 w-full ">
                            <h1 className="font-semibold text-3xl flex justify-center w-2/3 ml-6">You searched for cafes within:</h1>
                            <span className="text-accent font-semibold text-3xl flex justify-center w-2/3">{cafe.searchCity}, {cafe.searchProvince}</span>
                        </div> 
                    : null}

                    <div className="justify-center w-med m-auto gap-10 grid grid-cols-3 mt-20">  
                    ...
                    {cafe.results === 0 && show === true ? (
                        <div className="flex justify-center flex-col items-center gap-y-6 my-20 mb-56 ">
                            <p className="text-2xl font-bold text-center text-accent">Sorry! 😥 We are still building our database, <br/> we don't have any results for this place for now.</p>
